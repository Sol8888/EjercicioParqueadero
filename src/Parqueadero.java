...
// -----------------------------------------------------------------
    ...
    /**
     * 2.1 Completa el siguiente método que retorna cuánto tiempo llevan en promedio los
    ...
    public double darTiempoPromedio() {
        ...
        return (double) totalTiempo / carrosContados;
    }

    /**
     * 2.2 Completa el siguiente método el cual retorna el carro que ha estado durante más
     * horas en el parqueadero. Si no hay ningún carro el método debe retornar null y en
     * caso de que haya dos carros con el mismo mayor número de horas se retorna el
     * primero.
     */
    public Carro hayCarroMasDeOchoHoras() {
        Carro carroMasDeOchoHoras = null;
        int maxHoras = 8; // Cambiar según la cantidad deseada
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado()) {
                ...
                if (tiempoEnParqueadero > maxHoras) {
                    ...
                    carroMasDeOchoHoras = carro;
                }
            }
        }

        return carroMasDeOchoHoras;
    }

    /**
     * 2.3 Completa el siguiente método que retorna un valor boolean indicando si hay un
     * carro que lleve más de 8 horas parqueado.
     */
    public boolean hayUnCarroMasDeOchoHoras() {
        return hayCarroMasDeOchoHoras() != null;
    }

    /**
     * 2.4 Completa el siguiente método que retorna en un ArrayList todos los carros que
     * llevan más de tres horas parqueados.
     */
    ...
    /**
     * 2.5 Completa el siguiente método que retorna un valor boolean indicando si hay dos
     * carros parqueados con la misma placa.
     */
